    ...
    if (authError.type === 'user_not_registered') {
      ...
      return (
        <div className="fixed inset-0 flex flex-col items-center justify-center gap-4 bg-background">
          <img src="https://media.base44.com/images/public/69d7dcee3ce725bf49f16135/e27af7809_generated_image.png" alt="Your Hub4Community" className="w-16 h-16 rounded-2xl" />
