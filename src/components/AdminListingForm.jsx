        ...
        <div className="space-y-4 mt-2">
          ...
          {listing?.plan !== "premium" ? (
            <a
              ...
              className="flex items-center gap-3 p-3 rounded-lg border border-border bg-muted/30 hover:border-primary hover:bg-primary/5 transition-colors cursor-pointer group"
            >
              <Switch checked={false} disabled className="pointer-events-none" />
              <div>
                <Label className="cursor-pointer text-muted-foreground group-hover:text-foreground transition-colors">
                  Featured Listing
                </Label>
                <p className="text-xs text-primary mt-0.5 font-medium">⭐ Premium plan only — click to upgrade →</p>
              </div>
            </a>
          ) : (
