...
export default function TermsOfUse() {
  usePageTitle("Terms of Use", {
    description: "The terms for using Community Hub, including listings, events and contributions across Bandon, West Cork and Ireland.",
    path: "/terms",
  });
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      ...
      <p className="text-base leading-relaxed mb-4" style={{ color: "#333333" }}>
        By using Community Hub, you agree to these simple terms. They help keep the directory useful and trustworthy for communities across Ireland, with a strong local starting point in Bandon and West Cork.
      </p>
      <ol className="space-y-3 text-sm leading-relaxed" style={{ color: "#333333" }}>
        ...
        <li><strong style={{ color: "#097275" }}>Use of the site.</strong> You'll use Community Hub lawfully and respectfully, and won't misuse, copy, scrape or disrupt the platform or its listings.</li>
        ...
        <li><strong style={{ color: "#097275" }}>No warranty.</strong> Community Hub is provided as-is. To the extent permitted by law, we aren't liable for losses arising from the use of listings or content on the site.</li>
